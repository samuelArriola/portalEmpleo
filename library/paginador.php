...
class paginador extends conexion
{
    ...
    public function paginador($columns,$table,$method,$page,$where,$array){
        ...
        if ($_pagi_actual != 1) {
           ...
           $_pagi_navegacion_temporal[] = "<li class='page-item'><a id='paginas1' class='page-link' href='#' onclick='"."get".$method."(".$_pagi_url.")'>$_pagi_nav_primera</a></li>"; 

           // Si no estamos en la página 1. Ponemos el enlace "anterior" 
           $_pagi_url = $_pagi_actual - 1; //será el número de página al que enlazamos 
           $_pagi_navegacion_temporal[] = "<li class='page-item'><a id='paginas1' class='page-link' href='#' onclick='"."get".$method."(".$_pagi_url.")'>$_pagi_nav_anterior</a></li>"; 
        }
        ...
        for ($_pagi_i = $_pagi_nav_desde; $_pagi_i<=$_pagi_nav_hasta; $_pagi_i++){
            ...
            if ($_pagi_i == $_pagi_actual) {
                 ...
                 $_pagi_navegacion_temporal[] = "<li class='page-item'><a class='page-link'><span id='paginas2'>$_pagi_i</span></a></li>"; 
            }else{
                // Si es cualquier otro. Se escribe el enlace a dicho número de página. 
                $_pagi_navegacion_temporal[] = "<li class='page-item'><a id='paginas1' class='page-link'  href='#' onclick='"."get".$method."(".$_pagi_i.")'> ".$_pagi_i." </a></li>"; 
            }
        ...
        if ($_pagi_actual < $_pagi_totalPags) {
            ...
            $_pagi_url = $_pagi_actual + 1; //será el número de página al que enlazamos 
            $_pagi_navegacion_temporal[] = "<li class='page-item'><a id='paginas1' class='page-link' href='#' onclick='"."get".$method."(".$_pagi_url.")'>$_pagi_nav_siguiente</a></li>"; 
             ...
             $_pagi_navegacion_temporal[] = "<li class='page-item'><a class=' page-link' href='#' onclick='"."get".$method."(".$_pagi_url.")'>$_pagi_nav_ultima</a></li>"; 
        }
         /* 
        ...
        */ 
        ...
        $response = $this->db->select3($columns,$table,$_pagi_inicial,$_pagi_cuantos,$where, $array); 
        if (is_array($response)) {
